        ...
        <div className="mt-5">
            ...
            >
                {data?.map((matches, index) => (
                    <Card onClick={() => handleClick(matches?.matchInfo?.matchId)} key={index} className={`lg:w-[440.84px]  lg:h-[192px] md:w-[340.84px]  w-auto  h-[182px] relative rounded-[12.23px] dark:bg-gray-800 ${index % 2 === 0 ? ' bg-[#022FF8] text-white' : null}`} >
