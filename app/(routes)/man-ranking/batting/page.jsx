                    ...
                    <div className=" lg:col-span-3 col-span-4">
                        <TabsContent value="odi">
                            <div className='p-5 mb-0 '>
                                <h2 className="lg:text-3xl  text-2xl font-bold tracking-tight">ICC Cricket ODI Rankings - Men's Batting</h2>
                            </div>
                        ...
                        <TabsContent value="t20">
                            <div className='p-5 mb-0 '>
                                <h2 className="lg:text-3xl text-2xl font-bold tracking-tight">ICC Cricket T20 Rankings - Men's Batting</h2>
                        ...
                        <div className='p-5 mb-0 '>
                                <h2 className="lg:text-3xl text-2xl font-bold tracking-tight">ICC Cricket Test Rankings - Men's Batting</h2>
                                <p className="text-sm text-muted-foreground">
                                    {/* {topStoryDetail?.data?.context} */}
                                </p>
                            </div>
