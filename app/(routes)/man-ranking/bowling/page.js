...
const Bowling = async () => {
    ...
    const odiData = await getMensRanking({ matchType: "bowlers/odi" });
    const t20Data = await getMensRanking({ matchType: "bowlers/t20" });
    const testData = await getMensRanking({ matchType: "bowlers/test" });
